...
<body>
 <div class="container">
    <form action="{{ route('admingiathitruong.store')  }}" method="post" class="beta-form-checkout" enctype="multipart/form-data">
        {!! csrf_field() !!}
        {{ method_field('POST') }}
 <!---heading---->
     <header class="heading"> Giá thị trường</header><hr></hr>
    <!---Form starting----> 
    <div class="row ">
     <!--- For Name---->
...
<div class="col-sm-12">
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="col-xs-8"  >
                                <input class="form-control" placeholder="Giá" name="price" type="text">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="col-xs-8"  >
                                <input class="form-control" placeholder="Hình ảnh" name="img" type="file">
                            </div>
                        </div>
                    </div>
                     ...
                     <div class="col-xs-8"  >
                                <input class="form-control" placeholder="Mô tả" name="detail" type="text" >
                            </div>
                        </div>
                    </div>
